                ...
                if (!empty($error_message)) {
                    ...
                    try {
                        ...
                        if ($stmt->execute()) {
                            ...
                            if ($stmt->execute()) {
                                header("Location: lecture_read.php?update={$lecture_id}");
                            } else {
                                echo "<div class='alert alert-danger'>Unable to update login record. Please try again.</div>";
                            }
                        } else {
                ...
                <table class='table table-hover table-dark table-responsive table-bordered'>
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="text-end">
                            ...
                            <?php echo "<a href='lecture_delete.php?lecture_id={$lecture_id}' class='btn btn-danger m-r-1em'><i class='fa-solid fa-trash'></i></a>"; ?>
                        </td>
                    </tr>
                </table>
            </form>
