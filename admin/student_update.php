                ...
                if (!empty($error_message)) {
                    ...
                    try {
                        ...
                        if ($stmt->execute()) {
                            ...
                            if ($stmt->execute()) {
                                header("Location: student_read.php?update={$student_id}");
                            } else {
                ...
                <table class='table table-hover table-dark table-responsive table-bordered'>
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="text-end">
                            ...
                            <?php echo "<a href='student_delete.php?student_id={$student_id}' class='btn btn-danger m-r-1em'><i class='fa-solid fa-trash'></i></a>"; ?>
                        </td>
                    </tr>
                </table>
            </form>
